...
def trade(context, data):
    for stock in context.stocks1:
        if data.can_trade(stock) and not data.is_stale(stock):
            ...
            try:
                fastk, fastd = talib.STOCHRSI(prices, timeperiod=14, fastk_period=5, fastd_period=3, fastd_matype=context.matype)
            except:
            ...
            buystatus= fastk < 20 or fastd < 20
            sellstatus= fastk > 80 or fastd > 80
